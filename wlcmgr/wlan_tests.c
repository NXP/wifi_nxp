...
static void dump_wlan_add_usage(void)
{
    ...
    (void)PRINTF(
        ...
        "\r\n");
#endif
    (void)PRINTF("      If using WPA3 Enterprise security, STA does not support wpa3-sb-192 parameters.\r\n");
...
#ifdef CONFIG_WPA_SUPP_CRYPTO_ENTERPRISE
    if (network.security.wpa3_sb_192 && network.role == WLAN_BSS_ROLE_STA)
    {
        dump_wlan_add_usage();
        (void)PRINTF("Error: for STA, 'wpa3_sb_192' parameter is invalid, please use 'wpa_sb'!\r\n");
        return;
    }
#endif
...
#endif
#ifdef CONFIG_AUTO_NULL_TX
    {"wlan-auto-null-tx", "<start/stop/oneshot>", test_wlan_auto_null_tx},
#endif
};
