...
#if CONFIG_SDIO_MULTI_PORT_TX_AGGR && !(FSL_USDHC_ENABLE_SCATTER_GATHER_TRANSFER || CONFIG_TX_RX_ZERO_COPY)
...
#if (CONFIG_SDIO_MULTI_PORT_RX_AGGR) && !(FSL_USDHC_ENABLE_SCATTER_GATHER_TRANSFER || CONFIG_TX_RX_ZERO_COPY)
