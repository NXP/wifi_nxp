 ...
 *
 * This function initializes the JSON generator. It also clears the buffer
 ...
 *
 * This function initializes the JSON generator without clearing the
 * received buffer. This can be useful for cases where the same buffer
 * is being used for creating the JSON as well as for any intermediate
 * computations (like encoding).
 * In order to NULL terminate the JSON string, the json_str_finish() API
 * needs to be called at the end, after the JSON is ready.
 *
 * \param[out] jptr A pointer to the structure json_str which will be used as a
 * handle for the rest of the json_str operations.
 * \param[out] buff A pointer to a buffer that will be used to store the
 ...
 *
 * This API NULL terminates the JSON string initialized using
