...
gpio_pin_config_t input_pin           = {kGPIO_DigitalInput, 0};
gpio_interrupt_config_t input_pin_cfg = {kGPIO_PinIntEnableEdge, kGPIO_PinIntEnableHighOrRise};
...
static void mcu_bridge_spi_master_cb(SPI_Type *base, spi_dma_handle_t *handle, status_t status, void *userData)
{
...
int mcu_bridge_init_spi_master(void)
{
    ...
    ret = (int)SPI_MasterTransferCreateHandleDMA(MCU_BRIDGE_SPI_MASTER, &masterHandle, mcu_bridge_spi_master_cb, NULL,
