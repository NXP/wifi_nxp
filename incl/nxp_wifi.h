...
#if CONFIG_NXP_WIFI_MAX_CSI_LOCAL_BUF
#define CONFIG_MAX_CSI_LOCAL_BUF CONFIG_NXP_WIFI_MAX_CSI_LOCAL_BUF
#endif
...
#if CONFIG_NXP_UART_WIFI_BRIDGE
...
#if CONFIG_WIFI_NM_WPA_SUPPLICANT_ROAMING_RETRY
#define CONFIG_WIFI_ROAMING_RETRY_CNT CONFIG_WIFI_NM_WPA_SUPPLICANT_ROAMING_RETRY
#else
...
#if CONFIG_NXP_FW_DUMP_FLASH_START_ADDR
#define CONFIG_FW_DUMP_FLASH_START_ADDR CONFIG_NXP_FW_DUMP_FLASH_START_ADDR
#endif

#if CONFIG_NXP_FW_DUMP_FLASH_ERASE_LENGTH
#define CONFIG_FW_DUMP_FLASH_ERASE_LENGTH CONFIG_NXP_FW_DUMP_FLASH_ERASE_LENGTH
#endif
