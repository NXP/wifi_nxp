...
#define WFA_BUFF_2K  2048
#define WFA_BUFF_4K  4096

#ifdef WFA_PC_CONSOLE
#define WFA_RESP_BUF_SZ WFA_BUFF_4K
#else
#define WFA_RESP_BUF_SZ WFA_BUFF_2K
#endif
...
#define SMACSTR "%02x:%02x:%02x:%02x:%02x:%02x"
#endif

#ifndef SMAC2STR
/** MAC address security print arguments */
#define SMAC2STR(a) (a)[0], (a)[1], (a)[2], (a)[3], (a)[4], (a)[5]
#endif
