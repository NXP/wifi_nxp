...
extern int xcCmdProcStaSetPowerSave(char *pcmdStr, BYTE *aBuf, int *aLen);
...
extern int xcCmdProcAPSet11n(char *pcmdStr, BYTE *aBuf, int *aLen);
...
extern int xcCmdProcAPSendADDBAReq(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcAPSetRfeature(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcAPSetRaduis(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcAPSet11d(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcApSet11nWireless(char *, BYTE *, int *);
extern int xcCmdProcApSetPmf(char *, BYTE *, int *);
extern int xcCmdProcApGetMacAddress(char *, BYTE *, int *);
extern int xcCmdProcApDeauthSta(char *, BYTE *, int *);

extern int xcCmdProcStaBssidPool(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcStaAddCredential(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcStaHS2Associate(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcStaHS2StaScan(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcdevHS2Setparameter(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcStaOSU(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcStaResetParm(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcStaPolicyUpdate(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcStaExecAction(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcDevConfigureIe(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcAPSet11h(char *pcmdStr, BYTE *aBuf, int *aLen);
extern int xcCmdProcDevExecAction(char *pcmdStr, BYTE *aBuf, int *aLen);
...
typeNameStr_t nameStr[] = {
    ...
    {WFA_STA_SET_POWER_SAVE_TLV, "sta_set_power_save", xcCmdProcStaSetPowerSave},
#ifndef WFA_STA_TB
    ...
    {WFA_AP_SET_11N_TLV, "ap_set_11n", xcCmdProcAPSet11n},
    {WFA_AP_RESET_DEFAULT_TLV, "ap_reset_default", xcCmdProcAPResetDefault},
    {WFA_AP_SET_STA_QOS_TLV, "ap_set_staqos", xcCmdProcAPSetStaQos},
    {WFA_AP_SET_AP_QOS_TLV, "ap_set_apqos", xcCmdProcAPSetAPQos},
    {WFA_AP_SEND_ADDBA_REQ_TLV, "ap_send_addba_req", xcCmdProcAPSendADDBAReq},
    {WFA_AP_SET_RFEATURE_TLV, "ap_set_rfeature", xcCmdProcAPSetRfeature},
    {WFA_AP_SET_RADIUS_TLV, "ap_set_radius", xcCmdProcAPSetRaduis},
    ...
    {WFA_AP_GET_MAC_ADDRESS_TLV, "ap_get_mac_address", xcCmdProcApGetMacAddress},
    {WFA_AP_DEAUTH_STA_TLV, "ap_deauth_sta", xcCmdProcApDeauthSta},

    {WFA_STA_BSSID_POOL_TLV, "sta_bssid_pool", xcCmdProcStaBssidPool},
    {WFA_STA_ADD_CREDENTIAL_TLV, "sta_add_credential", xcCmdProcStaAddCredential},
    {WFA_STA_HS2_ASSOCIATE_TLV, "sta_hs2_associate", xcCmdProcStaHS2Associate},
    {WFA_STA_HS2_STA_SCAN_TLV, "sta_scan", xcCmdProcStaHS2StaScan},
    {WFA_STA_HS2_DEV_SET_PARAMETER_TLV, "dev_set_parameter", xcCmdProcdevHS2Setparameter},
    {WFA_STA_OSU_TLV, "sta_osu", xcCmdProcStaOSU},
    {WFA_STA_RESET_PARM_TLV, "sta_reset_parm", xcCmdProcStaResetParm},
    {WFA_STA_STA_POLICY_UPDATE, "sta_policy_update", xcCmdProcStaPolicyUpdate},
    {WFA_STA_EXEC_ACTION_TLV, "sta_exec_action", xcCmdProcStaExecAction},
    {WFA_STA_DEV_SEND_FRAME_TLV, "sta_send_frame", xcCmdProcStaDevSendFrame},
    {WFA_STA_DEV_CONFIGURE_IE, "dev_configure_ie", xcCmdProcDevConfigureIe},
