...
int __must_check
omac1_aes_vector(const u8 *key, size_t key_len, size_t num_elem, const u8 *addr[], const size_t *len, u8 *mac);
...
int __must_check aes_ctr_encrypt(const u8 *key, size_t key_len, const u8 *nonce, u8 *data, size_t data_len);
...
int __must_check aes_gcm_ae(const u8 *key,
                            size_t key_len,
                            const u8 *iv,
                            size_t iv_len,
                            const u8 *plain,
                            ...
                            u8 *crypt,
                            u8 *tag);
int __must_check aes_gcm_ad(const u8 *key,
                            size_t key_len,
                            const u8 *iv,
                            size_t iv_len,
                            const u8 *crypt,
                            ...
                            u8 *plain);
int __must_check
aes_gmac(const u8 *key, size_t key_len, const u8 *iv, size_t iv_len, const u8 *aad, size_t aad_len, u8 *tag);
int __must_check aes_ccm_ae(const u8 *key,
                            size_t key_len,
                            const u8 *nonce,
                            size_t M,
                            const u8 *plain,
                            ...
                            u8 *crypt,
                            u8 *auth);
int __must_check aes_ccm_ad(const u8 *key,
                            size_t key_len,
                            const u8 *nonce,
                            size_t M,
                            const u8 *crypt,
