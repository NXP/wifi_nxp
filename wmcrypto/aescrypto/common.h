...
{
    return (((u64)a[0]) << 56) | (((u64)a[1]) << 48) | (((u64)a[2]) << 40) | (((u64)a[3]) << 32) | (((u64)a[4]) << 24) |
           (((u64)a[5]) << 16) | (((u64)a[6]) << 8) | ((u64)a[7]);
}
...
{
    return (((u64)a[7]) << 56) | (((u64)a[6]) << 48) | (((u64)a[5]) << 40) | (((u64)a[4]) << 32) | (((u64)a[3]) << 24) |
...
#ifndef bswap_32
#define bswap_32(a)                                                                                \
    ((((u32)(a) << 24) & 0xff000000) | (((u32)(a) << 8) & 0xff0000) | (((u32)(a) >> 8) & 0xff00) | \
     (((u32)(a) >> 24) & 0xff))
#endif
