...
## Supported Boards
- [MIMXRT1060-EVKB](../../../../examples/_boards/evkbmimxrt1060/ncp_examples/ncp_host/example_board_readme.md)

## NCP API reference doc
- [NCP API doc](../../../../examples/ncp_examples/ncp_host/NCP_API_reference.md)
